...
export const Introduction = () => {
  ...
  const PackageVersions = [
    ...
    },
    {
      ...
      img: "/images/documentation/supabase.png",
      version: "2.49.4",
    },
    {
      id: "5",
  ...
  return (
    <>
      <div id="version" className="md:scroll-m-[130px] scroll-m-28">
        ...
        <div className="w-full flex justify-between lg:gap-0 gap-6 lg:flex-nowrap flex-wrap p-6 rounded-md border border-secondary/20 dark:border-white/20">
          {PackageVersions &&
            PackageVersions.map((item) => {
              return (
                <div
                  key={item.id}
                  className="lg:w-1/5 md:w-full text-center lg:border-b-0 border-b lg:border-e lg:last:border-e-0 last:border-b-0 border-secondary/20 dark:border-white/20"
                >
                  <Image
                    src={item.img}
                    alt="npm-package"

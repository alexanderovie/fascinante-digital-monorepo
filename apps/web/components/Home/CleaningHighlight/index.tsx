          ...
          <div className='flex flex-col md:flex-row items-center justify-between gap-10'>
            <motion.div {...bottomAnimation} className="flex flex-col gap-10 max-w-2xl lg:pr-16">
                ...
                <div className='flex flex-col gap-4'>
                  <div className='flex flex-col gap-3'>
                    <div className="bg-primary w-fit flex-1 rounded-full py-1 px-4">
                      <p className="font-semibold text-white">Over 400 brands trust us</p>
                    </div>
                    <h2 className='font-semibold'>We turn small businesses into recognized brands</h2>
                  </div>
                  <p className='text-xl dark:text-white/70'>We combine data, design, and cultural insight to drive measurable growth across the U.S. and Latin America.</p>
                </div>
              ...
              <Link href={"/contact-us"} className="w-fit group flex items-center py-3 px-6 bg-secondary hover:bg-primary dark:bg-white/25 dark:hover:bg-primary rounded-sm transition-all duration-300">
                <span className="text-base text-white group-hover:text-white font-bold">Get Your Free Strategy Call</span>
              </Link>
            </motion.div>

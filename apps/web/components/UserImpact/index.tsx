          ...
          <div className="container">
            <div className='grid grid-cols-1 xxl:grid-cols-2'>
              ...
              <motion.div {...bottomAnimation} className='flex flex-col gap-5 py-20 xxl:py-52 xxl:items-start items-center text-center xxl:text-left'>
                <h2 className='text-6xl md:text-7xl font-bold text-secondary'>408K+</h2>
                <div className='flex flex-col gap-4'>
                  <h4 className='font-semibold text-secondary'>
                    People who have started <span className='text-primaryText font-semibold'>cleaning</span>
                  </h4>
                  <p className="text-secondary">Cleaning services in England cater to a wide range of needs from residential.</p>
                </div>
                <Link href={"/"} className='py-3.5 px-6 w-fit bg-primary hover:bg-darkPrimary rounded-md '>
